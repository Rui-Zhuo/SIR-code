...
c     &        nodos(grp,ntau,tau,pe,mnodos(2))    !OJO nodosp escala con la pe en el ultimo nodo 
     &         nodos_mult(grp,ntau,tau,pe,mnodos(2))  !Warning: interpolating the relative perturbation       
